...
test('imports every inbox note as a draft using local recommendations and keeps source files', async () => {
  ...
  const result = await importInbox({ inboxDir, siteDir, date: '2026-08-12', base: '/daoson_website/knowledge/' })
  ...
  assert.match(imported, /\/daoson_website\/knowledge\/notes\/conditional-edge\/branch.png/)
