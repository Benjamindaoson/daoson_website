...
test('generates a public index containing published note discovery data only', async () => {
  ...
  assert.match(feed, /<link>https:\/\/benjamindaoson\.github\.io\/daoson_website\/knowledge\/python\/tips<\/link>/)
  assert.match(sitemap, /https:\/\/benjamindaoson\.github\.io\/daoson_website\/knowledge\/python\/tips/)
})
