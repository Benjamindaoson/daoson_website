...
The public site has clear content and credible project boundaries, but its visual system still reads as a personal technical blog rather than the research-focused portfolio expected by technical hiring teams, founders, and collaborators. This is the right time to make the established research direction immediately legible without changing the site’s claims, routes, or publishing model.
...
- Affected code: Jekyll homepage and global stylesheet, projects-page presentation, VitePress theme tokens and home styles, and a new optimized hero asset.
- No URL, API, dependency, CMS, deployment, or framework changes.
- Verification: content/schema checks, Jekyll production build where locally permitted, VitePress build/tests, responsive browser checks, accessibility and visual regression assertions.
